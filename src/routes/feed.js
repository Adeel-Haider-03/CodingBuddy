...
feedRouter.get('/feed', userAuth, async (req, res) => {
    ...
    try {
        ...
        connections.forEach(connection => {                 //set will automatically handle duplicates so we don't have to worry about that and it will only store unique ids of users to hide from feed, even ours id too
